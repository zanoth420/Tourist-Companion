...
const I18N = {
  en: {
    ...
    'label.where': 'Where (optional — anywhere by default)',
    'region.cairo': 'Cairo & Giza', 'region.alex': 'Alexandria',
    'region.luxor': 'Luxor', 'region.aswan': 'Aswan & Abu Simbel',
    'region.redsea': 'Red Sea coast', 'region.sinai': 'Sinai',
    'note.fewer_days': 'Your trip fits in {n} of {m} days — add regions or interests to fill it.',
    'label.interests': 'Interests (focus the trip)',
  ...
  ar: {
    ...
    'label.where': 'أين؟ (اختياري — كل مصر افتراضيًا)',
    'region.cairo': 'القاهرة والجيزة', 'region.alex': 'الإسكندرية',
    'region.luxor': 'الأقصر', 'region.aswan': 'أسوان وأبو سمبل',
    'region.redsea': 'ساحل البحر الأحمر', 'region.sinai': 'سيناء',
    'note.fewer_days': 'رحلتك تكتمل في {n} من {m} أيام — أضف مناطق أو اهتمامات لملئها.',
    'label.interests': 'الاهتمامات (تركّز الرحلة)',
